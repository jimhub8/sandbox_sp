                            ...
                            <v-container grid-list-xl fluid>
                                <v-layout wrap>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="custom-select custom-select-md col-md-12" v-model="form.country_id" @change="country_branch">
...
export default {
    ...
    methods: {
        save() {
            this.loading = true
            axios.patch(`/riders/${this.form.id}`, this.form).
            then((response) => {
                    // alert('error1')
                    this.loading = false
    ...
    created () {
        eventBus.$on('editRiderEvent', data => {
            this.dialog = true
            this.form = data
        });
    },
