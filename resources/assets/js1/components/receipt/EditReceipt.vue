                ...
                <v-container grid-list-xl fluid>
                  ...
                  <v-layout wrap>
                    ...
                    <v-flex xs12 sm6>
                      ...
                      <v-text-field v-model="receiptData.receipt_no" color="blue darken-2" label="Invoice Number" required></v-text-field>
                    ...
                    <v-flex xs12 sm6>
                      ...
                      <v-text-field v-model="receiptData.due_date" color="blue darken-2" label="Due Date" type='date' required></v-text-field>
                    ...
                    <v-flex xs12 sm6>
                      ...
                      <v-text-field v-model="receiptData.invoice_date" color="blue darken-2" label="Invoice Date" type='date' required></v-text-field>
                    ...
                    <v-flex xs12 sm6>
                      ...
                      <v-text-field v-model="receiptData.grand_total" color="blue darken-2" label="Grand Total" required></v-text-field>
  ...
  export default {
    ...
    methods: {
      ...
      addLine: function() {
        ...
        this.receiptData.products.push({
