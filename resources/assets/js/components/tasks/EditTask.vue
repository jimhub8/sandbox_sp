                        ...
                        <v-form ref="form" @submit.prevent>
                            <v-container grid-list-xl fluid>
                                <v-layout wrap>
                                    ...
                                    <v-flex xs12>
                                        <v-textarea v-model="task.description" color="blue">
                                            <div slot="label">
    ...
    data() {
        ...
        return {
            ...
            items: [
                ...
                {
                    state: 'Every 5 Minite',
                    abbr: 'everyFiveMinutes()',
                },
                {
                    state: 'Every Hour',
                    abbr: 'hourly()',
    ...
    methods: {
        save() {
            ...
            then((response) => {
                    ...
                    Object.assign(this.$parent.AllTasks[this.$parent.editedIndex], this.$parent.edittask)
                })
                .catch((error) => {
                    this.loading = false
