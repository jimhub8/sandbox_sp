                        ...
                        <v-flex sm12>
                            <v-card-text>
                                ...
                                <div class="block">
                                    ...
                                    <el-date-picker v-model="value1" type="date" placeholder="Pick a day" style="width: 100%;">
                                    </el-date-picker>
                                </div>
                                <div class="block">
                                ...
                                <div>
                                    ...
                                    <el-input placeholder="Leave name" v-model="form.leave_name"></el-input>
                                </div>
                                <div>
...
export default {
    ...
    created() {
        eventBus.$on("openEditLeave", data => {
            this.form = data
            this.dialog = true;
        });
    },
